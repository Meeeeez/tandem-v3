export const de = {
  ...
  hero: {
    titlePre: "Let’s",
    titleHighlight: "Fly",
    subtitle: "Tandemfliegen in den Dolomiten",
  },

  cta: {
    overline: "Val Gardena · Dolomiten",
    titlePre: "Bereit zum",
    titleHighlight: "Abheben",
    titlePost: "?",
    description:
      "Jederzeit buchbar. Keine Vorkenntnisse nötig. Dein Pilot führt dich sicher durch die Lüfte.",
    book: "Jetzt buchen",
    whatsapp: "WhatsApp",
  },
  ...
  footer: {
    ...
    legal:
      "© {year} Air Adventures des Samuel Messner · Josefweg 1, 39040 Funes (BZ), Italy · P.IVA IT01234567890",
    impressum: "Impressum",
    privacy: "Datenschutz",
    backToTop: "Nach oben",
  },
  ...
  reviews: {
    ...
    highlight: {
      quote: "„Das Beeindruckendste, was ich je erlebt habe“",
      name: "Hannah Messner",
      details: "Thermik • August 2025",
    },
    items: [
      {
        rating: 5,
        quote:
          "Der absolute Höhepunkt unserer Reise. Luca gab uns von der ersten Sekunde an ein sicheres Gefühl, und der Blick auf die Geisler-Spitzen war einfach unbeschreiblich.",
        name: "Sarah K.",
        flightType: "Abenteuer",
        flightDate: "Juni 2025",
      },
      {
        rating: 5,
        quote:
          "Mein erster Flug überhaupt! Am liebsten würde ich das jetzt jedes Wochenende machen. Sanfter Start, weiche Landung, tolle Fotos zum Schluss.",
        name: "Marco D.",
        flightType: "Gleitflug",
        flightDate: "Mai 2025",
      },
      {
        rating: 5,
        quote:
          "Die 40 Minuten kamen mir vor wie 5. Professionell, herzlich, und die Location spricht ohnehin für sich.",
        name: "James P.",
        flightType: "Gipfelflug",
  ...
  process: {
    header: {
      title: "Dein Tandemflug <br>",
      titleHighlighted: "Schritt für Schritt",
      description:
        "Hier erfährst du, wie dein Gleitschirmflug abläuft.",
    },
    slides: [
      {
        title: "Anfragen",
        description: "Sende uns eine Nachricht und wir finden einen passenden Termin für dich.",
        imageAlt: "Tandemflug anfragen",
      },
      {
        title: "Treffen",
        description:
      ...
      },
      {
        title: "Landen",
        description:
          "Wir landen mit einem sanften Anflug und ein paar Schritten wieder auf dem Boden.",
        imageAlt: "Die Landung",
      },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Bequeme Hosen, geschlossene Schuhe (Bergschuhe sind ideal, keine Sandalen) und eine leichte Jacke. Am Startplatz ist es selbst im Sommer 5 bis 10 Grad kühler als im Tal. Eine Sonnenbrille ist ebenfalls praktisch. Helm und Gurtzeug stellen wir dir zur Verfügung.",
      },
      {
  ...
  booking: {
    ...
    summaryDynamic: {
      empty: "—",
      passengers1: "1 Passagier",
      passengers2: "2 Passagiere",
      passengers3: "3 Passagiere",
      passengers4Plus: "4 oder mehr",
      dateLocale: "de-DE",
    },
    steps: {
      nameTitle:
      ...
      whatsappFieldTitle:
        "Wie lautet deine <span class=\"BookingStep__hl\">WhatsApp Nummer</span>?",
